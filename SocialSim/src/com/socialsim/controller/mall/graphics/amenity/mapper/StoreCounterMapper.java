...
import com.socialsim.model.core.environment.mall.patchobject.passable.goal.StoreCounter;

import java.util.ArrayList;
import java.util.List;

public class StoreCounterMapper extends AmenityMapper {
    ...
    public static void draw(List<Patch> patches) {
        ...
        for (Patch patch : patches) {
            ...
            Amenity.AmenityBlock.AmenityBlockFactory amenityBlockFactory = StoreCounter.StoreCounterBlock.storeCounterBlockFactory;
            ...
            StoreCounter storeCounterToAdd = StoreCounter.StoreCounterFactory.create(amenityBlocks, true, 15);
            Main.mallSimulator.getMall().getStoreCounters().add(storeCounterToAdd);

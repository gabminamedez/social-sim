...
public class MallAgentGraphic extends Graphic {
    ...
    static {
        ...
        for (int i = 0; i < 4; i++) { maleErrandFamily.add(new AgentGraphicLocation(0, i)); }
        femaleErrandFamily = new ArrayList<>();
        for (int i = 0; i < 4; i++) { femaleErrandFamily.add(new AgentGraphicLocation(1, i)); }
        maleLoiterFamily = new ArrayList<>();
        for (int i = 0; i < 4; i++) { maleLoiterFamily.add(new AgentGraphicLocation(2, i)); }
        femaleLoiterFamily = new ArrayList<>();
        for (int i = 0; i < 4; i++) { femaleLoiterFamily.add(new AgentGraphicLocation(3, i)); }

        maleErrandFriends = new ArrayList<>();
        for (int i = 0; i < 4; i++) { maleErrandFriends.add(new AgentGraphicLocation(4, i)); }
        femaleErrandFriends = new ArrayList<>();
        for (int i = 0; i < 4; i++) { femaleErrandFriends.add(new AgentGraphicLocation(5, i)); }
        maleLoiterFriends = new ArrayList<>();
        for (int i = 0; i < 4; i++) { maleLoiterFriends.add(new AgentGraphicLocation(6, i)); }
        femaleLoiterFriends = new ArrayList<>();
        for (int i = 0; i < 4; i++) { femaleLoiterFriends.add(new AgentGraphicLocation(7, i)); }

        maleErrandCouple = new ArrayList<>();
        for (int i = 0; i < 4; i++) { maleErrandCouple.add(new AgentGraphicLocation(8, i)); }
        femaleErrandCouple = new ArrayList<>();
        for (int i = 0; i < 4; i++) { femaleErrandCouple.add(new AgentGraphicLocation(9, i)); }
        maleLoiterCouple = new ArrayList<>();
        for (int i = 0; i < 4; i++) { maleLoiterCouple.add(new AgentGraphicLocation(10, i)); }
        femaleLoiterCouple = new ArrayList<>();
        for (int i = 0; i < 4; i++) { femaleLoiterCouple.add(new AgentGraphicLocation(11, i)); }

        maleErrandAlone = new ArrayList<>();
        for (int i = 0; i < 4; i++) { maleErrandAlone.add(new AgentGraphicLocation(12, i)); }
        femaleErrandAlone = new ArrayList<>();
        for (int i = 0; i < 4; i++) { femaleErrandAlone.add(new AgentGraphicLocation(13, i)); }
        maleLoiterAlone = new ArrayList<>();
        for (int i = 0; i < 4; i++) { maleLoiterAlone.add(new AgentGraphicLocation(14, i)); }
        femaleLoiterAlone = new ArrayList<>();
        for (int i = 0; i < 4; i++) { femaleLoiterAlone.add(new AgentGraphicLocation(15, i)); }

        maleStaffStore = new ArrayList<>();
        for (int i = 0; i < 4; i++) { maleStaffStore.add(new AgentGraphicLocation(16, i)); }
        femaleStaffStore = new ArrayList<>();
        for (int i = 0; i < 4; i++) { femaleStaffStore.add(new AgentGraphicLocation(17, i)); }
        maleStaffKiosk = new ArrayList<>();
        for (int i = 0; i < 4; i++) { maleStaffKiosk.add(new AgentGraphicLocation(18, i)); }
        femaleStaffKiosk = new ArrayList<>();
        for (int i = 0; i < 4; i++) { femaleStaffKiosk.add(new AgentGraphicLocation(19, i)); }
        maleStaffResto = new ArrayList<>();
        for (int i = 0; i < 4; i++) { maleStaffResto.add(new AgentGraphicLocation(20, i)); }
        femaleStaffResto = new ArrayList<>();
        for (int i = 0; i < 4; i++) { femaleStaffResto.add(new AgentGraphicLocation(21, i)); }
        maleGuard = new ArrayList<>();
        for (int i = 0; i < 4; i++) { maleGuard.add(new AgentGraphicLocation(22, i)); }
        femaleGuard = new ArrayList<>();
        for (int i = 0; i < 4; i++) { femaleGuard.add(new AgentGraphicLocation(23, i)); }
    }

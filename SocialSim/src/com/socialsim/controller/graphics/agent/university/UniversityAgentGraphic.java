package com.socialsim.controller.graphics.agent.university;
...
public class UniversityAgentGraphic extends Graphic {
    ...
    public UniversityAgentGraphic(UniversityAgent agent) {
        ...
        else if (agent.getType() == UniversityAgent.Type.PROFESSOR && agent.getGender() == UniversityAgent.Gender.MALE) {
            agentGraphics = maleProfessorGraphics;
        }
        else if (agent.getType() == UniversityAgent.Type.PROFESSOR && agent.getGender() == UniversityAgent.Gender.FEMALE) {
            agentGraphics = femaleProfessorGraphics;
        }
        else if (agent.getType() == UniversityAgent.Type.STUDENT && agent.getGender() == UniversityAgent.Gender.MALE) {
            agentGraphics = maleStudentGraphics;
        }
        else if (agent.getType() == UniversityAgent.Type.STUDENT && agent.getGender() == UniversityAgent.Gender.FEMALE) {

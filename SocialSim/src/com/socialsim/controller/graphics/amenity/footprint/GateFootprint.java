...
public class GateFootprint extends AmenityFootprint {
    ...
    public static class GateRotation extends Rotation {
        ...
        public static class GateBlockTemplate extends AmenityBlockTemplate {
            ...
            public GateBlockTemplate(Orientation orientation, int rowOffset, int columnOffset, Class<? extends Amenity> amenityClass, boolean attractor, boolean spawner, boolean hasGraphic) {

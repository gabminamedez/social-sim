...
//        GroceryAgent.agentCount++;
        GroceryAgent cashier2 = grocery.getAgents().get(2);
...
//        GroceryAgent.cashierCount++;
//        GroceryAgent.agentCount++;
        GroceryAgent cashier4 = grocery.getAgents().get(3);
...
//        GroceryAgent.cashierCount++;
//        GroceryAgent.agentCount++;
        GroceryAgent cashier6 = grocery.getAgents().get(4);
...
//        GroceryAgent.cashierCount++;
//        GroceryAgent.agentCount++;
        GroceryAgent cashier8 = grocery.getAgents().get(5);
...
//        GroceryAgent.agentCount++;
        GroceryAgent bagger2 = grocery.getAgents().get(6);
...
//        GroceryAgent.baggerCount++;
//        GroceryAgent.agentCount++;
        GroceryAgent bagger4 = grocery.getAgents().get(7);
...
//        GroceryAgent.baggerCount++;
//        GroceryAgent.agentCount++;
        GroceryAgent bagger6 = grocery.getAgents().get(8);
...
//        GroceryAgent.baggerCount++;
//        GroceryAgent.agentCount++;
        GroceryAgent bagger8 = grocery.getAgents().get(9);
        ...
        GroceryAgent service1 = grocery.getAgents().get(10);
        ...
        GroceryAgent.agentCount++;
        GroceryAgent service2 = grocery.getAgents().get(11);
        ...
        GroceryAgent.customerServiceCount++;
        GroceryAgent.agentCount++;
        GroceryAgent service3 = grocery.getAgents().get(12);
        ...
        GroceryAgent food1 = grocery.getAgents().get(13);
        ...
        GroceryAgent.agentCount++;
        GroceryAgent food2 = grocery.getAgents().get(14);
        ...
        GroceryAgent.staffFoodCount++;
        GroceryAgent.agentCount++;
        GroceryAgent food3 = grocery.getAgents().get(15);
        ...
        GroceryAgent.staffFoodCount++;
        GroceryAgent.agentCount++;
        GroceryAgent food4 = grocery.getAgents().get(16);
        ...
        GroceryAgent.staffFoodCount++;
        GroceryAgent.agentCount++;
        GroceryAgent food5 = grocery.getAgents().get(17);
        ...
        GroceryAgent butcher1 = grocery.getAgents().get(18);
        ...
        GroceryAgent.agentCount++;
        GroceryAgent butcher2 = grocery.getAgents().get(19);
        ...
        GroceryAgent aisle1 = grocery.getAgents().get(20);
        ...
        GroceryAgent.agentCount++;
        GroceryAgent aisle2 = grocery.getAgents().get(21);
        ...
        GroceryAgent.staffAisleCount++;
        GroceryAgent.agentCount++;
        GroceryAgent aisle3 = grocery.getAgents().get(22);
        ...
        GroceryAgent.staffAisleCount++;
        GroceryAgent.agentCount++;
        GroceryAgent aisle4 = grocery.getAgents().get(23);
        ...
        GroceryAgent.staffAisleCount++;
        GroceryAgent.agentCount++;
        GroceryAgent aisle5 = grocery.getAgents().get(24);
        ...
        GroceryAgent.staffAisleCount++;
        GroceryAgent.agentCount++;
        GroceryAgent aisle6 = grocery.getAgents().get(25);
        ...
        GroceryAgent.staffAisleCount++;
        GroceryAgent.agentCount++;
        GroceryAgent aisle7 = grocery.getAgents().get(26);
        ...
        GroceryAgent.staffAisleCount++;
        GroceryAgent.agentCount++;
        GroceryAgent aisle8 = grocery.getAgents().get(27);
        ...
        GroceryAgent.staffAisleCount++;
        GroceryAgent.agentCount++;
        GroceryAgent aisle9 = grocery.getAgents().get(28);

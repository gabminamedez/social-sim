...
//        GroceryAgent.agentCount++;
        GroceryAgent food2 = grocery.getAgents().get(21);
...
//        GroceryAgent.staffFoodCount++;
//        GroceryAgent.agentCount++;
        GroceryAgent food4 = grocery.getAgents().get(22);
...
//        GroceryAgent.agentCount++;
        ...
        GroceryAgent butcher1 = grocery.getAgents().get(23);
        ...
        GroceryAgent.agentCount++;
        GroceryAgent butcher2 = grocery.getAgents().get(24);
        ...
        GroceryAgent aisle1 = grocery.getAgents().get(25);
        ...
        GroceryAgent.agentCount++;
        GroceryAgent aisle2 = grocery.getAgents().get(26);
        ...
        GroceryAgent.staffAisleCount++;
        GroceryAgent.agentCount++;
        GroceryAgent aisle3 = grocery.getAgents().get(27);
        ...
        GroceryAgent.staffAisleCount++;
        GroceryAgent.agentCount++;
        GroceryAgent aisle4 = grocery.getAgents().get(28);
        ...
        GroceryAgent.staffAisleCount++;
        GroceryAgent.agentCount++;
        GroceryAgent aisle5 = grocery.getAgents().get(29);
        ...
        GroceryAgent.staffAisleCount++;
        GroceryAgent.agentCount++;
        GroceryAgent aisle6 = grocery.getAgents().get(30);
        ...
        GroceryAgent.staffAisleCount++;
        GroceryAgent.agentCount++;
        GroceryAgent aisle7 = grocery.getAgents().get(31);
        ...
        GroceryAgent.staffAisleCount++;
        GroceryAgent.agentCount++;
        GroceryAgent aisle8 = grocery.getAgents().get(32);
        ...
        GroceryAgent.staffAisleCount++;
        GroceryAgent.agentCount++;
        GroceryAgent aisle9 = grocery.getAgents().get(33);

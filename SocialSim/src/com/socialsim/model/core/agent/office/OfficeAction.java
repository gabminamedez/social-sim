...
public class OfficeAction {
    ...
    public enum Name {
        ...
        GO_TO_BATHROOM, FIND_CUBICLE, RELIEVE_IN_CUBICLE, WASH_IN_SINK, LEAVE_BATHROOM,
        GO_TO_PRINTER, QUEUE_PRINTER, PRINTING,
        GO_TO_COLLAB, WAIT_FOR_COLLAB, COLLABORATE,
        TECHNICAL_GO_PRINTER, FIX_PRINTER,
        TECHNICAL_GO_CUBICLE, FIX_CUBICLE,
        GO_MEETING, WAIT_MEETING, MEETING, LEAVE_MEETING
    }

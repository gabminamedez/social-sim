...
public class MallAction {
    ...
    public enum Name {
        GOING_TO_SECURITY_QUEUE, GO_THROUGH_SCANNER,
        FIND_DIRECTORY, VIEW_DIRECTORY, FIND_BENCH, SIT_ON_BENCH,
        GO_TO_BATHROOM, RELIEVE_IN_CUBICLE, WASH_IN_SINK,
        GO_TO_STORE, CHECK_AISLE, GO_TO_AISLE, CHECKOUT_STORE,
        GO_TO_KIOSK, QUEUE_KIOSK, CHECKOUT_KIOSK,
        GO_TO_RESTAURANT, RESTAURANT_STAY_PUT,
        GO_TO_DINING_AREA, DINING_AREA_STAY_PUT,
        LEAVE_BUILDING,
        GUARD_STATION, STAFF_KIOSK_STATION, STAFF_RESTO_SERVE, STAFF_STORE_STATION
    }

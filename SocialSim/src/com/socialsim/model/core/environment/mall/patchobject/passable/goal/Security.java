...
public class Security extends BlockableAmenity {
    ...
    public static class SecurityFactory extends Goal.GoalFactory {
        public static com.socialsim.model.core.environment.mall.patchobject.passable.goal.Security create(List<AmenityBlock> amenityBlocks, boolean enabled, int waitingTime, boolean blockAgents) {
            return new com.socialsim.model.core.environment.mall.patchobject.passable.goal.Security(amenityBlocks, enabled, waitingTime, blockAgents);
        }
    }

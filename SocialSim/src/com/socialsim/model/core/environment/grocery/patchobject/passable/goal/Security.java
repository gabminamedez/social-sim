...
public class Security extends BlockableAmenity {
    ...
    protected Security(List<Amenity.AmenityBlock> amenityBlocks, boolean enabled, int waitingTime, boolean blockAgents) {
    ...
    public static class SecurityFactory extends Goal.GoalFactory {
        public static Security create(List<Amenity.AmenityBlock> amenityBlocks, boolean enabled, int waitingTime, boolean blockAgents) {

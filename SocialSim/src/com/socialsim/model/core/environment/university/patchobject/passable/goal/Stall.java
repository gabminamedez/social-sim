...
public class Stall extends QueueableGoal {
    ...
    private UniversityAgent agentActing; // Takes note of the agent currently acting in the stall
    ...
    protected Stall(List<AmenityBlock> amenityBlocks, boolean enabled, int waitingTime) {
        ...
        // this.stallPatchFieldState = new QueueingPatchField.PatchFieldState(UniversityAgentMovement.Disposition.BOARDING, UniversityAgentMovement.State.IN_QUEUE, this);
    ...
    public static class StallBlock extends AmenityBlock {
    ...
    public static class StallFactory extends Goal.GoalFactory {
        public static Stall create(List<AmenityBlock> amenityBlocks, boolean enabled, int waitingTime) {
